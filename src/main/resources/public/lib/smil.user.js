...
function Animator(anim, target, index) {
	...
	if (nodeName=="animateColor") {
		...
		var parent = this.anim.parentNode;
		...
		if (this.path) {
			this.valueAt = function(percent) {
				...
				var point1 = this.path.getPointAtLength(percent*length);
				var point2 = this.path.getPointAtLength((percent+0.01)*length);
				
				if(point1.x < point2.x && point1.y == point2.y) {
					if(!this.keyPoints){
						//parent.setAttribute("d", "M2.5,2.5 L2.5,-2.5 L5,0z");
						angle = '0'; //this.target.setAttribute("transform", "rotate(90)")

					} else {
						//parent.setAttribute("d", "M-2.5,2.5 L-2.5,-2.5 L-5,0z");
						angle = '180'; //this.target.setAttribute("transform", "rotate(180)")
					}
					...
					if(!this.keyPoints) {
						...
						angle = '0'; //parent.setAttribute("d", "M2.5,2.5 L2.5,-2.5 L5,0z");
					}
				} else if(point1.x == point2.x && point1.y > point2.y) {
					if(this.keyPoints) {
						angle = '90'; //parent.setAttribute("d", "M-2.5,2.5 L2.5,2.5 L0,5z");
					} else {
						angle = '270';
						//parent.setAttribute("d", "M-2.5,2.5 L2.5,2.5 L0,0z");
					}
				} else if(point1.x == point2.x && point1.y < point2.y) {
					if(this.keyPoints) {
						angle = '270'; //parent.setAttribute("d", "M-2.5,2.5 L2.5,2.5 L0,0z");
					} else {
						angle = '90'; //parent.setAttribute("d", "M-2.5,2.5 L2.5,2.5 L0,5z");
					}
				} 
		...
		this.step = function(value) {
			...
			this.target.setAttribute("transform", value + ' rotate(' + angle + ')');
		};
