 ...
 */
	...
	SlideAlbumsManager = function () {
        ...
        SlideAlbumsManager.prototype.getSlideAlbums = function () { 
    		var url = "http://localhost:6789/spark/api/public/slidealbums"; //API_BASE_URL + '/api/getSlideAlbums';
    		var type = 'POST';	 
        ...
        SlideAlbumsManager.prototype.deleteSlideAlbum = function (title, customer) {    
        	var url = "http://localhost:6789/spark/api/public/slidealbums/delete"; //API_BASE_URL + '/api/deleteSlideAlbum';
    		var type = 'POST';	 
    	...
    	CreateSlideAlbumDialog.prototype.attachFileUploader = function() {
    		...
    		$(function () {
    		    $('#fileupload').fileupload({
    		    	...
    		    	'url': 'http://localhost:6789/spark/api/slidealbums/create', //config['api_base_url'] + '/src/upload/',
    		        'add': function (e, data) {		
